...
const github_analysis_service_1 = require("./github-analysis.service");
...
describe('GitHubAnalysisService', () => {
    ...
    beforeEach(async () => {
        ...
        const module = await testing_1.Test.createTestingModule({
            providers: [
                ...
                { provide: rate_limiter_service_1.RateLimiterService, useValue: mockRateLimiter },
                { provide: config_1.ConfigService, useValue: mockConfig },
            ],
        }).compile();
        service = module.get(github_analysis_service_1.GitHubAnalysisService);
    ...
    describe('syncCandidateOSSContributions', () => {
        ...
        it('should mark small PRs as not significant', async () => {
            ...
            expect(mockPrisma.oSSContribution.upsert).toHaveBeenCalledWith(expect.objectContaining({
...
//# sourceMappingURL=github-analysis.service.spec.js.map